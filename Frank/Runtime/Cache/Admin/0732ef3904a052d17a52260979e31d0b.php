                ...
                <div class="ibox-content">
                    ...
                    <table class="table">
                        ...
                        <?php if(is_array($doctor)): foreach($doctor as $key=>$vo): ?><tr>
                                ...
                                <td><?php echo ($vo["mz_time"]); ?></td>
                                <td><?php echo ($vo["winter_time"]); ?></td>
                                <td><?php echo ($vo["summer_time"]); ?></td>
                                <td><?php echo ($vo["Inpatient"]); ?></td>
                    ...
                    <!--<div class="row">-->
                        <!--<div class="col-sm-6 b-r">-->
                            <!--<form role="form">-->
                                <!--<div class="form-group">-->
                                    <!--<label>姓名：</label>-->
                                    <!--<input type="test" id="name" placeholder="请输入姓名" class="form-control">-->
                                <!--</div>-->
                                <!--<div class="form-group">-->
                                    <!--<label>性别：</label>-->
                                    <!--<input type="test" id="sex" placeholder="请输入性别" class="form-control">-->
                                <!--</div>-->
                                <!--<div class="form-group">-->
                                    <!--<label>年龄：</label>-->
                                    <!--<input type="test" id="age" placeholder="请输入年龄" class="form-control">-->
                                <!--</div>-->
                                <!--<div>-->
                                        ...
                                        <div id="image" class="image">
                                            <div id="45" class="goods_img_row">
                                                <a href="{echo tplgetimg($obj.thumb_image)}" target="_blank">
                                                    <img src="{echo tplgetimg($obj.thumb_image)}" height="80" width="80" style="text-align: center" data-img="">
                                                </a>
                                                <div class="del">
