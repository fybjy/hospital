            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="text-center">
                        <!--<a data-toggle="modal" class="btn btn-primary" href="form_basic.html#modal-form">增加账号</a>-->
                    </div>
                ...
                <div class="ibox-content">
                    ...
                    <table class="table">
                        ...
                        <?php if($user == '' ): ?><div style="text-align: center">暂无数据</div>
                            <?php else: ?>
                    ...
                    <div class="row">
                        <div class="col-sm-6 b-r">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>账号：</label>
                                    <input type="email" id="username" placeholder="请输入姓名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>密码：</label>
                                    <input type="email" id="password" placeholder="请输入性别" class="form-control">
                                </div>
                                <div>
...
<script>
    ...
    $("#submit").click(function () {
        ...
        $.ajax({
            url: "<?php echo U(admin_user);?>?action=add",
            dataType: "json",
            type: "post",
            data: {
                username: username,
...
//        var id = $(this).attr("id");
        $.ajax({
            url: "<?php echo U(admin_user);?>?action=delete",
            dataType: "json",
            type: "post",
            data: {
                id: id,
